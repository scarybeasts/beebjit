...
void asm_x64_emit_jit_JMP_IND(struct util_buffer* p_buf, uint16_t addr);
...
void asm_x64_jit_JMP_IND();
void asm_x64_jit_JMP_IND_addr_patch();
void asm_x64_jit_JMP_IND_END();
